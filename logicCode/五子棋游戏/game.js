...
canvas.addEventListener("click", function(e) {
  if (!chessMapArr.length) return; // 未开始游戏，则不响应画布点击
  //判断游戏是否结束
  if (flag) {
    alert("Game Over~");
    return;
